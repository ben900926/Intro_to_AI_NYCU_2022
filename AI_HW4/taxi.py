...
class Agent():
    ...
    def choose_action(self, state):
        ...
        # exploit an action with largest q value if not
        else:
    ...
    def learn(self, state, action, reward, next_state, done):
        ...
        self.qtable[state,action] = self.qtable[state,action] + self.learning_rate*(reward + self.gamma*
                                    max_next_q - self.qtable[state,action])
        # End your code
